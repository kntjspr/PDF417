...
var PDF417 = {
	...
	init: function(code, ecl, aspectratio) {		
		...
		*/
		//change this
			cols = document.getElementById('colrow').value
...
function go() {
  ...
  if (stateID.value == 'AL') {
    var iin = "636033";
    var lin = document.getElementById('linum').value;
...
// Add slashes "/" on expiry date to make it look better
//var expiryDateDisplay = expiryDate.replace(/^(\d{2})(\d{2})/, '$1/$2/');
...
<body>
  ...
  <br>
    <br>
	    <br>
  Number of Column in PDF417:
  <br>
  <input type="text" name="colrow" id="colrow" placeholder="10" value="10"></input>
<br>
<br>
  License Number:
  <br>
    <input type="text" name="lincensenum" id="linum" placeholder="D12345678"></input>
	<br>
<br>
  Issue Date:
  <br>
...
-->
  ...
  <br>
  <br>
   <a href="/dlgen.php">Go Back to Basic Mode</a> 
</body>
</html>
