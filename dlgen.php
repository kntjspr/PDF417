...
var PDF417 = {
	...
	init: function(code, ecl, aspectratio) {		
		...
		var cols = Math.round((Math.sqrt(4761 + (68 * aspectratio * this.ROWHEIGHT * nce)) - 69) / 34);
		 ...
		 if(!cols) {
                	alert("Can't Generate. No barcode columns are defined");
			throw new Error("Can't Generate. No barcode columns are defined");
			return;
			}else if(cols == 0) {
			alert("Can't Generate. No barcode columns are defined");
			throw new Error("Can't Generate. No barcode columns are defined");
...
<body>
  ...
  <br>
  <input type="text" name="colrow" id="colrow" placeholder="Number of column in pdf417"></input>
...
-->
  ...
  <br>
  <br>
   <a href="https://h3ll0x00x-parser.herokuapp.com/dlgenadvanced.php">Go to Advanced Mode</a> 
</body>
</html>
